...
import ecommerce from "../assets/ecommerce-product-page.jpg";
    ...
    <div name="work" className="w-full md:h-screen text-gray-300 bg-[#0a192f]">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div
            style={{ backgroundImage: `url(${multiStepForm})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  target="https://multi-step-form-reactjs.netlify.app/"
                  href="https://multi-step-form-reactjs.netlify.app/"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
                  </button>
                ...
                <a
                  target="https://github.com/Sandrex233/multi-step-form"
                  href="https://github.com/Sandrex233/multi-step-form"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
                  </button>
